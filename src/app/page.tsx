...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col relative" style={{
            ...
            <div className='flex flex-row gap-8 w-full items-center justify-center'>
              <div className='flex flex-row bg-white w-full md:w-[80%] px-2 py-2 rounded-full shadow-xl'>
                <div className='flex flex-1 justify-start items-center'>
                  ...
                  <p className='text-xs md:text-base text-slate-500 hidden sm:block'>Busca por el nombre o tu ubicacion...</p>
      ...
      <div className='absolute top-[30%] right-5 rotate-12 hidden md:block'>
        <Image
          src={burger}
          width={0}
          height={0}
      ...
      <div className='absolute top-[60%] left-24 rotate-6 hidden md:block'>
        <Image
          src={popsicle}
          width={0}
          height={0}
